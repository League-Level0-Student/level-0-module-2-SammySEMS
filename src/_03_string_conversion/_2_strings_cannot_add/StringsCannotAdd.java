...
ficeAsString=("5");
		// 1) Make a main method that includes all the steps below…. 
			...
			JOptionPane.showInputDialog("5");
			// 6) Print the addition of the variables fourAsString, sixAsString, and fiveAsString 
			JOptionPane.showMessageDialog(fourAsString + sixAsString + fiveAsString);
			...
			int sixAsString =Integer.parseInt(sixAsString);
			// 8) Print the addition of fourAsInt and sixAsInt using JOptionPane 
			JOptionPane.showMessageDialog(fourAsString + sixAsString);
